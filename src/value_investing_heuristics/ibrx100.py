"""Composicao ESTATICA atual do IBrX-100 (a API da B3 e bloqueada por Cloudflare).

ATENCAO - survivorship bias: por ser estatica e atual, NAO reconstroi a carteira
historica do indice; aplica-la a anos passados nao corrige survivorship bias e
pode ate introduzi-lo. Use apenas como recorte de liquidez, nao como controle de
sobrevivencia.

Para atualizar: em sistemaswebb3-listados.b3.com.br/indexPage/, selecionar IBXX,
exportar a lista e substituir _IBRX100_STATIC abaixo.
"""
